...
\textbf{Instructors:}
This course is co-taught by Prof.~Taylor Arnold (\texttt{tarnold2@richmond.edu}) and Prof.~Sam Kellogg (\texttt{sam.kellogg@richmond.edu}). Both of us will be in class and either of us is happy to hear from you about anything to do with the course material, the readings, the homework, or the project. Prof.~Arnold is the instructor of record, so please direct any questions about grades to him.
...
fourteen-day window, document it, check it, analyze it, and present it in a short pre-recorded video. The full description, including the schedule and the deliverables, is posted on the course website. Two class meetings are set aside as project workshops, and the final class periods are held as open office hours over Zoom while you finish the project. There are no live presentations.
